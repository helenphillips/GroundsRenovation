...
\begin{tabular}{P{2.8cm}  P{8.5cm} P{1.7cm} P{1.2cm} P{1.2cm} P{4.7cm}} \hline
...
All code used in this analysis is available at github: \url{https://github.com/helenphillips/GroundsRenovation}.
